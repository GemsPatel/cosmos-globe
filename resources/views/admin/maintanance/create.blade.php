...
<div class="content-wrapper">
      ...
      <section class="content">
            <div class="container-fluid">
                  <!-- form start -->
                  <form method="POST" action="{{route('admin.maintanance.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                              <!-- left column -->
                              <div class="col-md-6">
                                    ...
                                    <div class="card card-primary">
                                          <div class="card-header">
                                                <h3 class="card-title">New Maintanance</h3>
                                          </div>
                                          <!-- /.card-header -->
                                          ...
                                          <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <textarea class="form-control" id="short_description" name="short_description" placeholder="{{ __('Description') }}" ></textarea>

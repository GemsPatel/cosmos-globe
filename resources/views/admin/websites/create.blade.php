...
<div class="content-wrapper">
      ...
      <section class="content">
            <div class="container-fluid">
                  <form method="POST" class="dropzone needsclick" action="{{route('admin.website.store')}}" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" placeholder="{{ __('Website Name') }}" value="{{old('name')}}">
                                            @if($errors->has('name'))
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="google_analytics_code" name="google_analytics_code" placeholder="{{ __('Google Analytic Code') }}" value="{{old('google_analytics_code')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="google_tag_manager_code" name="google_tag_manager_code" placeholder="{{ __('Google Tag Manager Code') }}" value="{{old('google_tag_manager_code')}}">
